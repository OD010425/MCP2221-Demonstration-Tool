...
const char* Mcp2210_GetErrorName(int ErrorCode)
{
	switch (ErrorCode)
	{
        {
    case 0:		return (char*)"E_SUCCESS";							case -1: return "E_ERR_UNKOWN_ERROR";            case -2: return "E_ERR_INVALID_PARAMETER";
...
const char* Mcp2221_GetErrorName(int ErrorCode)
{
	switch (ErrorCode)
	{
		/********************************
